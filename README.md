...
- **甲米 2027/05 五方案比較**（另一趟獨立旅程）：高雄出發七日跳島浮潛的五種走法並排比較——全浮潛跳島／Phi Phi 過夜／蘭塔駐紮／遠端大島／雨季保險型。含三個決定性前提警示、人數可調的費用試算、可切換比較軸的並排表、季風應變對照、公園費與「訂票前待查證清單」（可勾選、存本機）。所有時刻票價標前季參考，匯率標為可調整假設值。
- **東京觀光組・最晚出發方案**：12/15 先在東京觀光的人，倒推時間鏈（19:00 → 山の駅 → 長野 → 東京），算出**東京最晚出發 ≈ 15:44** 與觀光時間預算（約 6–7 小時），三選項：最晚緊張／建議餘裕／計程車備案，各自標緩衝與 ✓/⚠。
